...
import DDPG
import logger
from mujoco_dset import MujocoDset
...
if __name__ == "__main__":
    ...
    log_dir = osp.join(args.log_dir, str(args.env_name), str(args.seed))
    ...
    demo_obs, demo_acs, demo_rews, demo_next_obs, demo_dones = dataset.get_all_data()
